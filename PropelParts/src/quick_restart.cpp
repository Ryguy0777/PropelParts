...
kmCallDefCpp(0x8013D8EC, void) {
    dScStage_c::m_exitMode = dScStage_c::EXIT_1;
    ...
    if(((!daPyMng_c::mRest[0]) || 
        ...
        dScStage_c::setNextScene(fProfile::GAME_OVER, 0, dScStage_c::EXIT_1, dFader_c::FADER_BOWSER);
        return;
    }
    ...
    if (pressed & (WPAD_BUTTON_2 | WPAD_BUTTON_A) ||
        dInfo_c::mGameFlag & (dInfo_c::GAME_FLAG_IS_COIN_BATTLE | dInfo_c::GAME_FLAG_IS_FREE_MODE)) {
        dScStage_c::setNextScene(fProfile::WORLD_MAP, 0, dScStage_c::EXIT_1, dFader_c::FADER_BOWSER);
        return;
    }

    dFader_c::setFader(dFader_c::FADER_BOWSER);
