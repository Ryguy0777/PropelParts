...
struct DRMStruct {
    ...
    f32 out_orthoLeft;
    f32 out_orthoRight;
    nw4r::math::MTX34 out_camMtx0;
    nw4r::math::MTX34 out_camMtx1;
};

void calculateCamera(const EGG::Vector3f &pos, const EGG::Vector3f &target, const EGG::Vector3f &up, nw4r::math::MTX34 &mtx) {
    EGG::Vector3f a = EGG::Vector3f(pos.x - target.x, pos.y - target.y, pos.z - target.z);
    a.normalise();
    EGG::Vector3f b = EGG::Vector3f(up.y * a.z - up.z * a.y, up.z * a.x - up.x * a.z, up.x * a.y - up.y * a.x);
    b.normalise();
    EGG::Vector3f c = EGG::Vector3f(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x);
    c.normalise();
